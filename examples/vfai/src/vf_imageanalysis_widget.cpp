...
#include "vf_imageanalysis_widget.hpp"


vf::ImageAnalysisWidget::ImageAnalysisWidget(QWidget *parent) :
...
void vf::ImageAnalysisWidget::initUI()
{
...
void vf::ImageAnalysisWidget::initConnections()
{
}

void vf::ImageAnalysisWidget::updateImage(QPixmap pix)
{
  pixmap_.setPixmap(pix);
}

void vf::ImageAnalysisWidget::initCtrlUI()
{
...
void vf::ImageAnalysisWidget::addProcessor(vf::ImageProcessor *ptr)
{
